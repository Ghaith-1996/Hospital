...
const alerts: AlertRecord[] = [
  {
    ...
    displayTitle: "Chest pain, hypotension",
  ...
  },
  {
    ...
    label: "SIMULATION: fictional respiratory distress accepted by Dr. Marc Tremblay.",
    displayTitle: "Respiratory distress",
    patientReference: "SIM-PAT-1003",
    location: "South Wing / Simulation Room 8",
    department: "Fictional Emergency",
    urgency: "critical",
    caseDetails: "SIMULATION: fictional respiratory distress accepted by Dr. Marc Tremblay.",
    status: "in-progress",
  ...
  },
  {
    ...
    displayTitle: "Post-op hypotension",
  ...
  },
  {
    ...
    label: "SIMULATION: fictional suspected sepsis escalation moving through backup coverage.",
    displayTitle: "Suspected sepsis",
    patientReference: "SIM-PAT-1005",
    location: "North Wing / Simulation Room 21",
    department: "Fictional Emergency",
    urgency: "critical",
    caseDetails: "SIMULATION: fictional suspected sepsis escalation moving through backup coverage.",
    status: "escalating",
